...
from dbnet.infer_onnxruntime import dbnet_model
from crnn.infer_onnxruntime import crnn_model


def init_args():
    parser = argparse.ArgumentParser(description='DBNet.pytorch')
    parser.add_argument('--dbnet_path', default='../../data/model_zoo/dbnet_simp.onnx', type=str)
    parser.add_argument('--crnn_path', default='../../data/model_zoo/crnn_simp.onnx', type=str)
    parser.add_argument('--image_path', default='test_images/word.jpg', type=str, help='img path for predict')
...
if __name__ == '__main__':
    ...
    for i,cnts in enumerate(contours):
        ...
        cv2.fillPoly(mask_t, [cnts], (255), 8, 0)
    ...
    if args.output_folder:
        ...
        cv2.imwrite(args.output_folder + '/predict.png', img_draw)
